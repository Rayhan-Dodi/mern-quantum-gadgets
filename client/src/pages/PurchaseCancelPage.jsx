      ...
      >
        <div className="p-6 sm:p-8">
          ...
          <p className="text-gray-300 text-center mb-6">
            Your transaction has been cancelled successfully. No payment was
            processed.
          </p>
          <div className="bg-gray-700 rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-400 text-center">
              If something went wrong or you need help, feel free to reach out
              to our support team—we're here for you.
            </p>
          </div>
